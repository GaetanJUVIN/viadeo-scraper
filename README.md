[![Build Status](https://secure.travis-ci.org/yatish27/viadeo-scraper.png)](http://travis-ci.org/yatish27/viadeo-scraper)
[![Gem Version](https://badge.fury.io/rb/viadeo-scraper.png)](http://badge.fury.io/rb/viadeo-scraper)
...
Initialize a scraper instance:
    ...
    profile = Viadeo::Profile.get_profile("http://fr.viadeo.com/fr/profile/etienne.salvan")

With a http web-proxy
    profile = Viadeo::Profile.get_profile("http://fr.viadeo.com/fr/profile/etienne.salvan", {:proxy_ip=>'127.0.0.1',:proxy_port=>'3128'})
...
For current and past comapnies it also provides the details of the companies like comapny size, industry, address, etc 
    ...
    [
    [0] {
             :current_company => "viadeo",
               :current_title => "CEO",
         :current_company_url => "http://www.viadeo.com",
                 :description => nil,
        :viadeo_company_url => "http://www.viadeo.com/company/viadeo?trk=ppro_cprof",
                         :url => "http://www.viadeo.com",
                        :type => "Public Company",
                :company_size => "1001-5000 employees",
                     :website => "http://www.viadeo.com",
                    :industry => "Internet",
                     :founded => "2003",
    ...
    [1] {
         ...
         :current_company_url => "http://network.intuit.com/",
                 :description => nil,
        :viadeo_company_url => "http://www.viadeo.com/company/intuit?trk=ppro_cprof",
    ...
    [2] {
         ...
         :current_company_url => "http://www.donorschoose.org",
                 :description => nil,
        :viadeo_company_url => "http://www.viadeo.com/company/donorschoose.org?trk=ppro_cprof",
    ...
    [4] {
         ...
         :current_company_url => "http://ventureforamerica.org/",
                 :description => nil,
        :viadeo_company_url => "http://www.viadeo.com/company/venture-for-america?trk=ppro_cprof",
    ...
    [0] {
        ...
        :past_company_website => "http://www.facebook.com/accel",
                 :description => nil,
        :viadeo_company_url => "http://www.viadeo.com/company/accel-partners?trk=ppro_cprof",
    ...
    [1] {
        ...
        :past_company_website => "http://www.greylock.com",
                 :description => nil,
        :viadeo_company_url => "http://www.viadeo.com/company/greylock-partners?trk=ppro_cprof",
    ...
    [2] {
        ...
        :past_company_website => "http://www.yahoo.com",
                 :description => nil,
        :viadeo_company_url => "http://www.viadeo.com/company/yahoo?trk=ppro_cprof",
    ...
    [4] {
        ...
        :past_company_website => "http://www.warnerbros.com/",
                 :description => nil,
        :viadeo_company_url => "http://www.viadeo.com/company/warner-bros.-entertainment-group-of-companies?trk=ppro_cprof",
    ...
    [
    [0] {
           :link => "http://www.viadeo.com/in/barackobama?trk=pub-pbmap",
           :name => "Barack Obama",
          :title => "President of the United States of ",
        :company => nil
    },
    [1] {
           :link => "http://www.viadeo.com/in/marissamayer?trk=pub-pbmap",
           :name => "Marissa Mayer",
          :title => "Yahoo!, President & CEO",
        :company => nil
    },
    [2] {
           :link => "http://www.viadeo.com/pub/sean-parker/0/1/826?trk=pub-pbmap",
           :name => "Sean Parker",
          :title => nil,
        :company => nil
    },
    [3] {
           :link => "http://www.viadeo.com/pub/eduardo-saverin/0/70a/31b?trk=pub-pbmap",
           :name => "Eduardo Saverin",
          :title => nil,
        :company => nil
    },
    [4] {
           :link => "http://www.viadeo.com/in/rbranson?trk=pub-pbmap",
           :name => "Richard Branson",
          :title => "Founder",
        :company => "Virgin Group"
    },
    [5] {
           :link => "http://www.viadeo.com/in/reidhoffman?trk=pub-pbmap",
           :name => "Reid Hoffman",
          :title => "Entrepreneur. Product Strategist.  ",
        :company => nil
    },
    [6] {
           :link => "http://www.viadeo.com/in/mdell?trk=pub-pbmap",
           :name => "Michael Dell",
          :title => "Chairman and CEO",
        :company => "Dell"
    },
    [7] {
           :link => "http://www.viadeo.com/in/mittromney?trk=pub-pbmap",
           :name => "Mitt Romney",
          :title => "Believe in America",
        :company => nil
    },
    [8] {
           :link => "http://www.viadeo.com/pub/sheryl-sandberg/2/665/512?trk=pub-pbmap",
...
The gem also comes with a binary and can be used from the command line to get a json response of the scraped data. It takes the url as the first argument.
    ...
    viadeo-scraper http://fr.viadeo.com/fr/profile/etienne.salvan
